    ...
    return (
        <>
          <div className="flex flex-col min-h-screen">
            <div className="min-h-screen w-full flex flex-col md:flex-row items-center justify-center bg-[#0f172a] text-white">
                {/* Left: Form */}
                ...
                <div className="hidden md:flex w-1/2 flex-col justify-between h-full px-10 py-16">
                        ...
                        <ul className="space-y-8">
                            <li>
                                ...
                                <p className="text-gray-400 text-xs ml-6">
                                    Log icome, expenses, and visualize spending patterns using interactive visualizations
                                </p>
                            </li>
      ...
      <p>
        © 2025 FinSight | <a href="https://github.com/haseebshaik00/FinSight" className="underline">GitHub</a>
        <br />
        Designed with <span className="text-pink-400">❤</span> by Haseeb and Varun.
      </p>
    </footer>
    </div>
        </>
